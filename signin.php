                                          ...
                                          <div class="col-md-6">
                                            <div id="serviceDetails">
                                              <div class="detail-box" id="detail1">
                                                  <p class="base-line"><a class="mega-menu-item mb-0" href="">Legal Assistance on PMLA- Benami and Under all other act lodged by Enforcement Directorate</a></p>
                                                  <p class="base-line"><a class="mega-menu-item" href="">Legal Assistance on Cases lodged by Central Bureau of Investigation</a></p>
                                                  <p class="base-line"><a class="mega-menu-item" href="">Legal Assistance on cases and other litigation lodged by GST (Central & State)</a></p>
                                                  <p class="base-line"><a class="mega-menu-item" href="">Legal Assistance on cases and litigation lodged by Income Tax Department</a></p>
                                                  <p class="base-line"><a class="mega-menu-item" href="">Legal Assistance on cases lodged by Customs</a></p>
                                                  <p class="base-line"><a class="mega-menu-item" href="">Legal documentation and contract management</a></p>
                                                  <p class="base-line"><a class="mega-menu-item" href="">Dispute resolution and arbitration</a></p>
                                              </div>
                                              <div class="detail-box d-none" id="detail2">
                                                  <p class="base-line"><a class="mega-menu-item mb-0" href="">Income Tax advisory and compliance</a></p>
                                                  <p class="base-line"><a class="mega-menu-item" href="">GST consultancy and return filing</a></p>
                                                  <p class="base-line"><a class="mega-menu-item" href="">Financial structuring and corporate tax optimization</a></p>
                                              </div>
                                              <div class="detail-box d-none" id="detail3">
                                                  <p class="base-line"><a class="mega-menu-item mb-0" href="">Representation before government bodies</a></p>
                                                  <p class="base-line"><a class="mega-menu-item" href="">Policy advocacy and regulatory updates</a></p>
                                                  <p class="base-line"><a class="mega-menu-item" href="">Facilitation of approvals and exemptions</a></p>
                                              </div>
                                            </div>
                                          </div>
                                        </div>
...
<div class="fables-header bg-rules" style="background-image: url(./assets/custom/images/signIn.png);">
    <div class="container"> 
         <h2 class="fables-page-title fables-main-text-color wow fadeInLeft" data-wow-duration="1.5s">Sign In</h2>
    </div>
</div>  
<!-- /End Header -->
...
<div class="container">
     <div class="row my-4 my-lg-5">
          <div class="col-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3 text-center">
               <p class="font-20 semi-font fables-main-text-color mt-4">Sign In</p>
               <p class="fables-forth-text-color text-center mb-lg-5">To post the blogs</p>
               <form action="login.php" method="POST">
                  ...
                  <a href="forgor_password.php" class="fables-forth-text-color font-16 fables-second-hover-color underline mt-3 mb-4 m-lg-5 d-block">Forgot Password ?</a>
                </form>
          </div>
     </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-lg-4">
               ...
               <div class="my-3">
                    ...
                    <p class="font-14 text-white mt-2 ml-4">Kalkaji, New Delhi</p>
                </div>
                <div class="my-3">
            ...
            <div class="col-12 col-sm-6 col-lg-4">
                ...
                <ul class="nav fables-footer-links">
                    ...
                    <li><a href="#" style="text-decoration: none;" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'">Privacy</a></li>
