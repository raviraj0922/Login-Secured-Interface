...
// Fetch data
$sql = "SELECT first_name, last_name, email, dob, phone, gender, position_applied, linkedin_url,
        current_address, permanent_address, resume_path, cover_letter_path, submitted_at FROM registrations";
...
<div class="container full-height d-flex flex-column py-5">
    <h2 class="mb-4 text-center">User's Applications</h2>
            ...
            <?php if ($result && $result->num_rows > 0): ?>
                <?php while($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td><a href="<?= htmlspecialchars($row['linkedin_url']) ?>" target="_blank">View Profile</a></td>
                        <td><?= nl2br(htmlspecialchars($row['current_address'])) ?></td>
                        <td><?= nl2br(htmlspecialchars($row['permanent_address'])) ?></td>
                        <td><a href="<?= htmlspecialchars($row['resume_path']) ?>" target="_blank">Download</a></td>
                        <td><a href="<?= htmlspecialchars($row['cover_letter_path']) ?>" target="_blank">Download</a></td>
